...
const Main = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <div name="home">
          ...
          <div className="text-2xl md:text-5xl text-center md:pt-0 px-2 font-heading">
            <h1
              id="name"
              className="p-4 font-bold text-[160%] lg:text-[250%] border-[#27274c] lg:hover:border-b-8 lg:hover:border-t-8 rounded-md transition-all"
            >
      ...
      <div className="invisible md:visible myDiv" ref={myDivRef}>
        <AnimatedWave
          color={"#1a3aba"}
